"""
train_attention_unet.py — Train the Attention U-Net segmentation model.
...
print(f"AttentionUNet  |  input channels: {CFG['n_channels']}  |  "
...
run_training_loop(
    ...
    criterion    = criterion,
    save_path    = "best_model_attention_unet.pt",
    arch         = "AttentionUNet",
